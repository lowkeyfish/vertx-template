...
public enum ErrorType {
    VALIDATION_REQUEST_BODY_EMPTY(400),
    VALIDATION_FAILED(400),
    VALIDATION_PASSWORD_FORMAT_INVALID(400),

    AUTHENTICATION_FAILED(401),
    AUTHENTICATION_TOKEN_INVALID(401),
    AUTHENTICATION_TOKEN_EXPIRED(401),
    AUTHENTICATION_TOKEN_ISSUER_INVALID(401),
    AUTHENTICATION_TOKEN_AUDIENCE_INVALID(401),
    AUTHORIZATION_FAILED(403),
    AUTHORIZATION_TOKEN_SCOPE_INVALID(403),
